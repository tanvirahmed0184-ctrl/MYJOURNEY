...
// 5. FIXED: Cross junction handling
// 6. FIXED: First loop last_turn initialization
...
void semi_pid(){
  ...
  if(sum > 0){
    ...
    // FIXED: Better handling when last_turn='s' (shouldn't happen now, but added safety)
