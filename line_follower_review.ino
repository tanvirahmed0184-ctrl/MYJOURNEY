...
void semi_pid(){
  ...
  else if(lmotor_actual > lmotor_target) lmotor_actual -= min(rate, lmotor_actual - lmotor_target);

  if(rmotor_actual < rmotor_target) rmotor_actual += min(rate, rmotor_target - rmotor_actual);
  else if(rmotor_actual > rmotor_target) rmotor_actual -= min(rate, rmotor_actual - rmotor_target);
